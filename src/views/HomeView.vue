            ...
            <v-col cols="12" sm="12">
              <v-app-bar color="rgba(0,0,0,0)" flat class="mx-8 mb-8 mt-3">
                ...
                <v-chip class="ma-2" color="white">
                  <v-icon left color="teal">mdi-clock-time-nine</v-icon> 14:02 AM Today Nov,19
                </v-chip>
              </v-app-bar>
            </v-col>
            <v-col cols="12" sm="12">
              <v-card class="mx-12 rounded-tl-xl rounded-tr-xl rounded-bl-xl rounded-bl-xl rounded-br-xl mt-n15">
    ...
    <v-flex md4>
      ...
      <v-container>
        <v-row>
          ...
          <v-col cols="12" sm="12">
            <v-btn text>November<v-icon right>mdi-chevron-down</v-icon></v-btn>
          </v-col>
          <v-col cols="12" sm="12">
            <v-list>
              <v-list-item>
          ...
          <v-col cols="12" sm="12">
            <v-card class="mx-12 rounded-tr-xl rounded-bl-xl rounded-br-xl mt-n4 py-4" color="teal lighten-5" flat>
              <v-list-item three-line>
                <v-list-item-avatar tile size="30">
                  <v-icon size="30">fas fa-heartbeat</v-icon>
                </v-list-item-avatar>
                <v-list-iitem-content class="pa-2">
                  <v-list-class-item-title class="headline mb-1">   
                    Cardiologist <br>
                    <h6>9:45 - 11:50</h6>
                    <h6>Dr. Elka Clark(cab 61)</h6>
          ...
          <v-col cols="12" sm="12">
            <v-btn text>Your Traitment</v-btn>
            ...
            <v-card class="mx-12 rounded-tl-xl rounded-tr-xl rounded-bl-xl rounded-br-xl mt-n4" color="teal lighten-5" flat>
              <v-list-item three-line>
                ...
                <v-list-item-content class="pa-2">
                  <v-list-item-title class="headline mb-1">
                    Gentle Iron<br>
                    <h6><span class="teal--text">2 capsules</span>with meals</h6>
                  </v-list-item-title>
                </v-list-item-content>
              </v-list-item>
            </v-card>
...
<script>
  export default {
    data: () => ({
      ...
      padding: 8,
      lineCap: 'round',
      value: [0,2,5,9,10,3,5,0,0,1,8,2,9,0],
      fill: false,
      type: 'trend',
      autoLineWidth: false
    }),
